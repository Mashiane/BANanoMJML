...
this.sendemail=function(_sfrom,_sto,_scc,_ssubject,_smsg) {
if (_B==null) _B=this;
...
this.savehtmlfile=function(_filename,_content) {
if (_B==null) _B=this;
var _bphp;
...
this.sendmjmlemail=function(_mailfromname,_mailfrom,_mailsubject,_mailrecipients,_mailhtml) {
if (_B==null) _B=this;
var _se,_bp;
