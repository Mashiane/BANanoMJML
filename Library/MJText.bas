...
#DesignerProperty: Key: LetterSpacing, DisplayName: LetterSpacing, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: LineHeight, DisplayName: LineHeight, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: Loremipsum, DisplayName: Loremipsum, FieldType: Boolean, DefaultValue: False , Description: 
...
Private mTagName As String = "mj-text"
...
Private stLetterSpacing As String = ""
Private stLineHeight As String = ""
Private boLoremipsum As Boolean = False
...
stLetterSpacing = Props.Get("LetterSpacing")
stLineHeight = Props.Get("LineHeight")
boLoremipsum = Props.Get("Loremipsum")
...
public Sub setLetterSpacing(varLetterSpacing As String)
AddAttr("letter-spacing", varLetterSpacing)
stLetterSpacing = varLetterSpacing
End Sub

public Sub getLetterSpacing() As String
Return stLetterSpacing
End Sub
...
public Sub setLoremipsum(varLoremipsum As Boolean)
AddAttr("LoremIpsum", varLoremipsum)
boLoremipsum = varLoremipsum
End Sub

public Sub getLoremipsum() As Boolean
Return boLoremipsum
End Sub
