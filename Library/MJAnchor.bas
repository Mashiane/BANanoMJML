...
#DesignerProperty: Key: Display, DisplayName: Display, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: MjContent, DisplayName: MjContent, FieldType: Boolean, DefaultValue: False , Description: 
...
public Sub setDisplay(varDisplay As String)
AddStyle("display", varDisplay)
stDisplay = varDisplay
End Sub

public Sub getDisplay() As String
Return stDisplay
End Sub
...
public Sub setMjContent(varMjContent As Boolean)
AddClass(varMjContent)
boMjContent = varMjContent
End Sub

public Sub getMjContent() As Boolean
Return boMjContent
End Sub
