...
#DesignerProperty: Key: BorderColor, DisplayName: BorderColor, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: BorderStyle, DisplayName: BorderStyle, FieldType: String, DefaultValue:  , Description: 
...
Private mTagName As String = "mj-divider"
...
AddAttr("border-color", stBorderColor)
AddAttr("border-style", stBorderStyle)
AddAttr("border-width", stBorderWidth)
...
AddAttr("border-color", varBorderColor)
...
AddAttr("border-style", varBorderStyle)
...
AddAttr("border-width", varBorderWidth)
