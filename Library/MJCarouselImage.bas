...
#DesignerProperty: Key: ThumbnailsSrc, DisplayName: ThumbnailsSrc, FieldType: String, DefaultValue:  , Description: 
...
Private mTagName As String = "mj-carousel-image"
...
Private stThumbnailsSrc As String = ""
...
stThumbnailsSrc = Props.Get("ThumbnailsSrc")
...
AddAttr("thumbnails-src", stThumbnailsSrc)
...
public Sub setThumbnailsSrc(varThumbnailsSrc As String)
AddAttr("thumbnails-src", varThumbnailsSrc)
stThumbnailsSrc = varThumbnailsSrc
End Sub

public Sub getThumbnailsSrc() As String
Return stThumbnailsSrc
End Sub
