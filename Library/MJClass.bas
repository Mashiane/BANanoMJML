...
#DesignerProperty: Key: FontColor, DisplayName: FontColor, FieldType: String, DefaultValue:  , Description: 
...
Private mTagName As String = "mj-class"
Private sbText As StringBuilder
Public bindings As Map
Private stColor As String = ""
Private stFontColor As String = ""
...
public Sub setFontColor(varFontColor As String)
AddAttr("font-color", varFontColor)
stFontColor = varFontColor
End Sub

public Sub getFontColor() As String
Return stFontColor
End Sub
