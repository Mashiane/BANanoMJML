...
#DesignerProperty: Key: InnerBackgroundColor, DisplayName: InnerBackgroundColor, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: InnerBorder, DisplayName: InnerBorder, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: InnerBorderBottom, DisplayName: InnerBorderBottom, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: InnerBorderLeft, DisplayName: InnerBorderLeft, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: InnerBorderRadius, DisplayName: InnerBorderRadius, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: InnerBorderRight, DisplayName: InnerBorderRight, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: InnerBorderTop, DisplayName: InnerBorderTop, FieldType: String, DefaultValue:  , Description: 
...
Private mTagName As String = "mj-column"
...
Private stInnerBackgroundColor As String = ""
Private stInnerBorder As String = ""
Private stInnerBorderBottom As String = ""
Private stInnerBorderLeft As String = ""
Private stInnerBorderRadius As String = ""
Private stInnerBorderRight As String = ""
Private stInnerBorderTop As String = ""
...
stInnerBackgroundColor = Props.Get("InnerBackgroundColor")
stInnerBorder = Props.Get("InnerBorder")
stInnerBorderBottom = Props.Get("InnerBorderBottom")
stInnerBorderLeft = Props.Get("InnerBorderLeft")
stInnerBorderRadius = Props.Get("InnerBorderRadius")
stInnerBorderRight = Props.Get("InnerBorderRight")
stInnerBorderTop = Props.Get("InnerBorderTop")
...
AddAttr("inner-background-color", stInnerBackgroundColor)
AddAttr("inner-border", stInnerBorder)
AddAttr("inner-border-bottom", stInnerBorderBottom)
AddAttr("inner-border-left", stInnerBorderLeft)
AddAttr("inner-border-radius", stInnerBorderRadius)
AddAttr("inner-border-right", stInnerBorderRight)
AddAttr("inner-border-top", stInnerBorderTop)
...
public Sub setInnerBackgroundColor(varInnerBackgroundColor As String)
AddAttr("inner-background-color", varInnerBackgroundColor)
stInnerBackgroundColor = varInnerBackgroundColor
End Sub

public Sub getInnerBackgroundColor() As String
Return stInnerBackgroundColor
End Sub

public Sub setInnerBorder(varInnerBorder As String)
AddAttr("inner-border", varInnerBorder)
stInnerBorder = varInnerBorder
End Sub

public Sub getInnerBorder() As String
Return stInnerBorder
End Sub

public Sub setInnerBorderBottom(varInnerBorderBottom As String)
AddAttr("inner-border-bottom", varInnerBorderBottom)
stInnerBorderBottom = varInnerBorderBottom
End Sub

public Sub getInnerBorderBottom() As String
Return stInnerBorderBottom
End Sub

public Sub setInnerBorderLeft(varInnerBorderLeft As String)
AddAttr("inner-border-left", varInnerBorderLeft)
stInnerBorderLeft = varInnerBorderLeft
End Sub

public Sub getInnerBorderLeft() As String
Return stInnerBorderLeft
End Sub

public Sub setInnerBorderRadius(varInnerBorderRadius As String)
AddAttr("inner-border-radius", varInnerBorderRadius)
stInnerBorderRadius = varInnerBorderRadius
End Sub

public Sub getInnerBorderRadius() As String
Return stInnerBorderRadius
End Sub

public Sub setInnerBorderRight(varInnerBorderRight As String)
AddAttr("inner-border-right", varInnerBorderRight)
stInnerBorderRight = varInnerBorderRight
End Sub

public Sub getInnerBorderRight() As String
Return stInnerBorderRight
End Sub

public Sub setInnerBorderTop(varInnerBorderTop As String)
AddAttr("inner-border-top", varInnerBorderTop)
stInnerBorderTop = varInnerBorderTop
End Sub

public Sub getInnerBorderTop() As String
Return stInnerBorderTop
End Sub
