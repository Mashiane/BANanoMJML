...
#DesignerProperty: Key: Inline, DisplayName: Inline, FieldType: String, DefaultValue: inline , Description: 
...
Private mTagName As String = "mj-style"
Private sbText As StringBuilder
Public bindings As Map
Private stInline As String = "inline"
End Sub
...
stInline = Props.Get("Inline")
End If

AddAttr("inline", stInline)
AddClass(mClasses)
...
public Sub setInline(varInline As String)
AddAttr("inline", varInline)
stInline = varInline
End Sub

public Sub getInline() As String
Return stInline
End Sub
